"""
Django settings for proyecto_u project.
...
SECRET_KEY = 'django-insecure-cq(yd-l!+ctv875%rc%&op8d!bqlt*e)41!81(=38u=8l-ec0b'
...
INSTALLED_APPS = [
    'mod_ventas',
    'mod_ventas.sub_mod_productos',
    'mod_ventas.sub_mod_descuentos',
...
STATICFILES_DIRS = [
    BASE_DIR / "static",
    # Add other directories if you have any
]
